...
// `include` also covers lib/web so shared @mochi/web strings land in this app's
// catalogs - there is no shared catalog, so a new lib/web string needs `pnpm
// i18n:extract` in every consuming app.
export default {
  sourceLocale: 'en',
